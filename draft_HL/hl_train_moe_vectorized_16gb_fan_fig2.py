...
wandb_run_name = 'sequence-moe-plt2'
...
"""
=> train on curated MMLU, with different block sizes?
=> 
"""
# ------------------------------
...
eval_iters = 21
log_interval = 1
plot_interval = 10   # plotting the routing figure less frequently to save overhead
