    ...
    if iter_num % log_interval == 0 and master_process:
        ...
        if wandb_log:
            ...
            base_log = {
                ...
                "lr": lr,
                "mfu": running_mfu*100,
                "layer0/expert0":target_hist[0]['freqs'][0][-1],
                "layer0/expert1":target_hist[0]['freqs'][1][-1],
                "layer0/expert2":target_hist[0]['freqs'][2][-1],
                "layer0/expert3":target_hist[0]['freqs'][3][-1],
                "layer1/expert0":target_hist[1]['freqs'][0][-1],
                "layer1/expert1":target_hist[1]['freqs'][1][-1],
                "layer1/expert2":target_hist[1]['freqs'][2][-1],
                "layer1/expert3":target_hist[1]['freqs'][3][-1],
                "layer2/expert0":target_hist[2]['freqs'][0][-1],
                "layer2/expert1":target_hist[2]['freqs'][1][-1],
                "layer2/expert2":target_hist[2]['freqs'][2][-1],
                "layer2/expert3":target_hist[2]['freqs'][3][-1],
                "layer3/expert0":target_hist[3]['freqs'][0][-1],
                "layer3/expert1":target_hist[3]['freqs'][1][-1],
                "layer3/expert2":target_hist[3]['freqs'][2][-1],
                "layer3/expert3":target_hist[3]['freqs'][3][-1],
                "layer4/expert0":target_hist[4]['freqs'][0][-1],
                "layer4/expert1":target_hist[4]['freqs'][1][-1],
                "layer4/expert2":target_hist[4]['freqs'][2][-1],
                "layer4/expert3":target_hist[4]['freqs'][3][-1],
                "layer5/expert0":target_hist[5]['freqs'][0][-1],
                "layer5/expert1":target_hist[5]['freqs'][1][-1],
                "layer5/expert2":target_hist[5]['freqs'][2][-1],
                "layer5/expert3":target_hist[5]['freqs'][3][-1],
                "layer6/expert0":target_hist[6]['freqs'][0][-1],
                "layer6/expert1":target_hist[6]['freqs'][1][-1],
                "layer6/expert2":target_hist[6]['freqs'][2][-1],
                "layer6/expert3":target_hist[6]['freqs'][3][-1],
                "layer7/expert0":target_hist[7]['freqs'][0][-1],
                "layer7/expert1":target_hist[7]['freqs'][1][-1],
                "layer7/expert2":target_hist[7]['freqs'][2][-1],
                "layer7/expert3":target_hist[7]['freqs'][3][-1],
                "layer8/expert0":target_hist[8]['freqs'][0][-1],
                "layer8/expert1":target_hist[8]['freqs'][1][-1],
                "layer8/expert2":target_hist[8]['freqs'][2][-1],
                "layer8/expert3":target_hist[8]['freqs'][3][-1],
                "layer9/expert0":target_hist[9]['freqs'][0][-1],
                "layer9/expert1":target_hist[9]['freqs'][1][-1],
                "layer9/expert2":target_hist[9]['freqs'][2][-1],
                "layer9/expert3":target_hist[9]['freqs'][3][-1],
                "layer10/expert0":target_hist[10]['freqs'][0][-1],
                "layer10/expert1":target_hist[10]['freqs'][1][-1],
                "layer10/expert2":target_hist[10]['freqs'][2][-1],
                "layer10/expert3":target_hist[10]['freqs'][3][-1],
                "layer11/expert0":target_hist[11]['freqs'][0][-1],
                "layer11/expert1":target_hist[11]['freqs'][1][-1],
                "layer11/expert2":target_hist[11]['freqs'][2][-1],
                "layer11/expert3":target_hist[11]['freqs'][3][-1],
